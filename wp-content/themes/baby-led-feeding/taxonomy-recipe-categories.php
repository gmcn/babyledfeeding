...
<?php
 ...
 <?php if( have_rows('flexible_front_page', $term) ): ?>
 	<?php while( have_rows('flexible_front_page', $term) ): the_row(); ?>
			...
			<?php elseif( get_row_layout() == 'newsletter' ): ?>
				...
				<?php include(locate_template("inc/page-front/newsletter.php")); ?>
